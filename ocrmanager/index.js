...
function startOCRManager(settingspath) {
    ...
    function setPDFSearchifyListeners(cb) {
        ...
        pdfsearchify.on('startPage', function(o) { winston.info('Starting page: '+o.pagenum); });
        pdfsearchify.on('donePage', function(o) { winston.info('Done page: '+o.pagenum+' ('+hrTimeString(o.time)+')'); });
        pdfsearchify.on('extractPage', function(o) { winston.info('Extracting page: '+o.pagenum); });
        pdfsearchify.on('pageExtracted', function(o) { winston.info('Extracted page: '+o.pagenum+' ('+hrTimeString(o.time)+')'); });
        pdfsearchify.on('cleanPage', function(o) { winston.info('Cleaning page: '+o.pagenum); });
        pdfsearchify.on('pageCleaned', function(o) { winston.info('Cleaned page: '+o.pagenum+' ('+hrTimeString(o.time)+')'); });
        pdfsearchify.on('ocrPage', function(o) { winston.info('Ocring page: '+o.pagenum); });
        pdfsearchify.on('pageOcred', function(o) { winston.info('Ocred page: '+o.pagenum+' ('+hrTimeString(o.time)+')'); });
        pdfsearchify.on('preparePage', function(o) { winston.info('Preparing page: '+o.pagenum); });
        pdfsearchify.on('pagePrepared', function(o) { winston.info('Prepared page: '+o.pagenum+' ('+hrTimeString(o.time)+')'); });
        pdfsearchify.on('composePage', function(o) { winston.info('Composing page: '+o.pagenum); });
        pdfsearchify.on('pageComposed', function(o) { winston.info('Composed page: '+o.pagenum+' ('+hrTimeString(o.time)+')'); });
